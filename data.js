...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      {
        label: {en:"🏔️ Mountains",fr:"🏔️ Montagne",ar:"🏔️ جبال"},
        tags: {mountain:3}
      }
    ]
  },
  {
    ...
    options: [
      {
        label: {en:"⚡ Fast-paced",fr:"⚡ Rythme rapide",ar:"⚡ سريع"},
        tags: {fast:3}
      },
      {
        label: {en:"🧘 Chill",fr:"🧘 Chill",ar:"🧘 رايق"},
        tags: {chill:3}
      }
    ]
  },
  {
    id: 3,
    question: {
      en: "Big city energy or small town warmth?",
      fr: "Énergie de grande ville ou chaleur de petite ville ?",
      ar: "طاقة المدينة الكبيرة ولا دفء البلدة الصغيرة؟"
    },
    options: [
      {
        label: {en:"🌆 Big city",fr:"🌆 Grande ville",ar:"🌆 مدينة كبيرة"},
        tags: {urban:3}
      },
      {
        label: {en:"🏘️ Small town",fr:"🏘️ Petite ville",ar:"🏘️ بلدة صغيرة"},
        tags: {traditional:3}
      }
    ]
  },
  {
    id: 4,
    question: {
      en: "Nightlife or early nights?",
      fr: "Vie nocturne ou soirées tranquilles ?",
      ar: "حياة ليلية ولا نوم بدري؟"
    },
    options: [
      {
        label: {en:"🍸 Nightlife",fr:"🍸 Vie nocturne",ar:"🍸 سهر"},
        tags: {nightlife:3}
      },
      {
        label: {en:"🌙 Early nights",fr:"🌙 Soirées calmes",ar:"🌙 نوم بدري"},
        tags: {family:3}
      }
    ]
  },
  {
    id: 5,
    question: {
      en: "Budget-conscious or don't care?",
      fr: "Économe ou tu t'en fiches ?",
      ar: "موفر ولا ما يهمكش؟"
    },
    options: [
      {
        label: {en:"💰 Budget-conscious",fr:"💰 Économe",ar:"💰 موفر"},
        tags: {low_budget:3}
      },
      {
        label: {en:"💎 Don't care",fr:"💎 Je m'en fiche",ar:"💎 ما يهمنيش"},
        tags: {mid_budget:3}
      }
    ]
  },
  {
    id: 6,
    question: {
      en: "Desert heat or four seasons?",
      fr: "Chaleur du désert ou quatre saisons ?",
      ar: "حر الصحراء ولا الفصول الأربعة؟"
    },
    options: [
      {
        label: {en:"🏜️ Desert heat",fr:"🏜️ Chaleur du désert",ar:"🏜️ حر الصحراء"},
        tags: {desert:3}
      },
      {
        label: {en:"🍂 Four seasons",fr:"🍂 Quatre saisons",ar:"🍂 أربعة فصول"},
        tags: {temperate:3}
      }
    ]
  },
  {
    id: 7,
    question: {
      en: "Historic vibes or modern life?",
      fr: "Ambiance historique ou vie moderne ?",
      ar: "أجواء تاريخية ولا حياة عصرية؟"
    },
    options: [
      {
        label: {en:"🏛️ Historic city",fr:"🏛️ Ville historique",ar:"🏛️ مدينة تاريخية"},
        tags: {historic:3}
      },
      {
        label: {en:"🏗️ Modern city",fr:"🏗️ Ville moderne",ar:"🏗️ مدينة عصرية"},
        tags: {modern:3}
      }
    ]
  },
  {
    id: 8,
    question: {
      en: "Tourist hotspot or local secret?",
      fr: "Spot touristique ou secret local ?",
      ar: "وجهة سياحية ولا سر محلي؟"
    },
    options: [
      {
        label: {en:"📸 Tourist favorite",fr:"📸 Incontournable",ar:"📸 مفضلة سياحية"},
        tags: {touristy:3}
      },
      {
        label: {en:"🤫 Hidden gem",fr:"🤫 Joyau caché",ar:"🤫 جوهرة مخفية"},
        tags: {local:3}
      }
    ]
  }
...
const CITIES = {
  ...
  oum_el_bouaghi: {
    ...
    image: null,
    tags: {mountain:1,temperate:1,chill:3,traditional:3,family:3,low_budget:3,historic:1,local:3}
  },
  batna: {
    name: "Batna",
    demonym: "BATNÉENNE",
  ...
  bouira: {
    ...
    tags: {mountain:3,temperate:1,chill:3,traditional:3,family:3,low_budget:3,historic:1,local:3}
  },
  tamanrasset: {
    name: "Tamanrasset",
  ...
  djelfa: {
    ...
    tags: {mountain:1,desert:3,chill:3,traditional:3,family:3,low_budget:3,historic:2,local:3}
  },
  jijel: {
    name: "Jijel",
    demonym: "JIJELIENNE",
  ...
  el_bayadh: {
    ...
    tags: {mountain:1,desert:2,chill:2,traditional:3,family:3,low_budget:3,historic:1,local:3}
  },
  illizi: {
    name: "Illizi",
    demonym: "ILLIZIENNE",
  ...
  el_tarf: {
    ...
    tags: {coastal:2,temperate:3,chill:3,traditional:2,family:2,low_budget:3,local:3,touristy:1}
  },
  tindouf: {
    name: "Tindouf",
  ...
  khenchela: {
    ...
    tags: {mountain:3,temperate:1,chill:2,traditional:3,family:3,low_budget:3,historic:1,local:3}
  },
  souk_ahras: {
    name: "Souk Ahras",
  ...
  na_ma: {
    ...
    tags: {mountain:1,desert:2,temperate:1,chill:3,traditional:2,family:2,low_budget:3,local:3}
  },
  a_n_t_mouchent: {
    name: "Aïn Témouchent",
  ...
  timimoun: {
    ...
    tags: {desert:3,chill:3,traditional:3,family:2,low_budget:3,historic:3,local:1,touristy:2}
  },
  bordj_badji_mokhtar: {
    ...
    tags: {desert:3,fast:1,chill:2,traditional:3,family:2,low_budget:3,historic:1,local:3}
  },
  ouled_djellal: {
    name: "Ouled Djellal",
  ...
  in_guezzam: {
    ...
    tags: {desert:3,fast:1,chill:2,traditional:3,family:2,low_budget:3,historic:2,local:3}
  },
  touggourt: {
    name: "Touggourt",
  ...
  el_abiodh_sidi_cheikh: {
    ...
    tags: {mountain:1,desert:3,chill:3,traditional:3,family:2,low_budget:3,historic:3,local:3}
  },
  el_kantara: {
    name: "El Kantara",
  ...
  el_aricha: {
    ...
    tags: {desert:1,temperate:2,chill:3,traditional:2,family:2,low_budget:3,historic:1,local:3}
  }
};
